...
const WorkExpStart: React.FC = () => {
  ...
  //function that deteccts if checkbox one was checked, and then unchecks the other box
    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        <IonItem>
          ...
          />
          <IonLabel class="ion-text-wrap">I have no substantial work experience - I'm just graduating high school</IonLabel>
        </IonItem>
        <IonItem>
          <IonCheckbox checked={checked2} name="option2" onIonChange={e => console.log("Second item checked!")} />
          <IonLabel class="ion-text-wrap">I have multiple years of experience in a skilled work environment</IonLabel>
        </IonItem>
        <IonItem>
          <IonCheckbox checked={false} name="option3" onIonChange={e => console.log("Third item checked!")} />
          <IonLabel class="ion-text-wrap">I have passed college credit tests (like CLEP) that will count towards my degree.</IonLabel>
        </IonItem>
